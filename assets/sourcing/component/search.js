...
function Search (props){
    ...
    const loadOptionRegion =(selectValueRegion,callback)=>{
        axios.get("https://localhost:8000/api/regions?nom="+ selectValueRegion)
            .then((reg)=>{
                callback(reg.data);
    ...
    const loadOptionDepartement =(selectValueDepartement,callback)=>{
        axios.get("https://localhost:8000/api/departements?nom=" + selectValueDepartement)
            .then((dep)=>{
                callback(dep.data);
    ...
    const loadOtionVille =(selectValueVille,callback)=>{
        axios.get("https://localhost:8000/api/villes?nom="+selectValueVille)
            .then((vil)=>{
